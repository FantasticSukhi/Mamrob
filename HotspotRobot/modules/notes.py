...
from HotspotRobot import DRAGONS, JOIN_LOGGER, LOGGER, SUPPORT_CHAT, dispatcher
from HotspotRobot.modules.disable import DisableAbleCommandHandler
from HotspotRobot.modules.helper_funcs.chat_status import connection_status, user_admin
from HotspotRobot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from HotspotRobot.modules.helper_funcs.msg_types import get_note_type
from HotspotRobot.modules.helper_funcs.string_handling import (
...
def __stats__():
    return f"<b>≛≛ ᴛᴏᴛᴀʟ ɴᴏᴛᴇꜱ :</b> <code>{sql.num_notes()}</code>"
