...
from HotspotRobot import TIGERS, WOLVES, dispatcher
...
from HotspotRobot.modules.helper_funcs.string_handling import split_quotes
from HotspotRobot.modules.channel import loggable
from HotspotRobot.modules.sql import warns_sql as sql
...
def __stats__():
    return f"<b>≛≛ ᴛᴏᴛᴀʟ ᴡᴀʀɴꜱ :</b> <code>{sql.num_warns()}</code>"
