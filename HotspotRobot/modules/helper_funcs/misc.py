...
from HotspotRobot import NO_LOAD, OWNER_ID
    ...
    if len(pairs) > 3:
        pairs = pairs[modulo_page * 4 : 4 * (modulo_page + 1)] + [
            (
                ...
                EqInlineKeyboardButton("• ʜᴏᴍᴇ •", callback_data="hotspot_back"),
                EqInlineKeyboardButton(
        ...
        pairs += [[EqInlineKeyboardButton("• ʙᴀᴄᴋ •", callback_data="hotspot_back")]]
