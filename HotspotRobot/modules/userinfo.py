...
import HotspotRobot.modules.sql.userinfo_sql as sql
...
from HotspotRobot import telethn as HotspotTelethonClient
from HotspotRobot.__main__ import STATS, TOKEN, USER_INFO
...
from HotspotRobot.modules.sql.afk_sql import check_afk_status, is_afk
from HotspotRobot.modules.sql.global_bans_sql import is_user_gbanned
from HotspotRobot.modules.sql.users_sql import get_user_num_chats
...
def set_about_bio(update: Update, context: CallbackContext):
    ...
    if message.reply_to_message:
        ...
        if user_id == bot.id and sender_id not in DEV_USERS:
            message.reply_text("Umm... yeah, I only trust Hotspotist to set my bio.")
            return
...
*Examples:*
 ...
 ➩ /setbio This user is a Hotspot (ʀᴇᴘʟʏ ᴛᴏ ᴛʜᴇ ᴜꜱᴇʀ)
