...
import HotspotRobot.modules.sql.chatbot_sql as sql
from HotspotRobot import dispatcher
from HotspotRobot.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from HotspotRobot.modules.helper_funcs.filters import CustomFilters
...
@user_admin_no_reply
@gloggable
def hotspotrm(update: Update, context: CallbackContext) -> str:
...
@user_admin_no_reply
@gloggable
def hotspotadd(update: Update, context: CallbackContext) -> str:
    query: Optional[CallbackQuery] = update.callback_query
    user: Optional[User] = update.effective_user
...
@user_admin
@gloggable
def itzhotspot(update: Update, context: CallbackContext):
...
CHATBOTK_HANDLER = CommandHandler("chatbot", itzhotspot)
ADD_CHAT_HANDLER = CallbackQueryHandler(hotspotadd, pattern=r"add_chat")
RM_CHAT_HANDLER = CallbackQueryHandler(hotspotrm, pattern=r"rm_chat")
