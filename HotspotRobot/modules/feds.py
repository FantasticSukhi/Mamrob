...
import HotspotRobot.modules.sql.feds_sql as sql
...
from HotspotRobot.modules.helper_funcs.string_handling import markdown_parser
...
# Federation update of Hotspot Robot v3 by Axen 2022
...
def __stats__():
    ...
    return f"<b>≛≛ ᴛᴏᴛᴀʟ ꜰʙᴀɴꜱ :</b> <code>{len(all_fbanned)}</code>\n<b>≛≛ ᴛᴏᴛᴀʟ ꜰᴇᴅꜱ :</b> <code>{len(all_feds)}</code>"
