...
from HotspotRobot.modules.helper_funcs.msg_types import Types
from HotspotRobot.modules.sql import BASE, SESSION
...
DEFAULT_WELCOME_MESSAGES = [
    ...
    "{first} joined the group, read by Hotspot, Mark Zuckerberg, CIA and 31 others.",
