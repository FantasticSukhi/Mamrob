...
import HotspotRobot
import HotspotRobot.modules.sql.welcome_sql as sql
...
from HotspotRobot.modules.helper_funcs.msg_types import get_welcome_type
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_text(
                    "Be cool! A member of the Hotspot Association just joined.",
                    reply_to_message_id=reply,
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
            ...
            # Welcome yourself
                ...
                creator = None
                if not HotspotRobot.ALLOW_CHATS:
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            # Give the devs a special goodbye
                ...
                update.effective_message.reply_text(
                    "See you later at the Hotspot's Association!",
                    reply_to_message_id=reply,
                )
                return
